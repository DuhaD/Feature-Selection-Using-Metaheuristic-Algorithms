...
filename = strcat('withwrapperselectionGA_',num2str(MaxIteration), '_', num2str(AgentsNum));
...
%             [training_selected, testing_selected , feature_selected] = relieffSelect(30,training_data,training_label,testing_data,features(:,1:end-1));
             ...
             [ Best_score , generations_best, individual , initime] = GA(dataset,MaxIteration,AgentsNum);
