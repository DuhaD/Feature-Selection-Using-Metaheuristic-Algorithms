...
for i=1:8 %8 datasets
    for algo = 1: 4 %4 algorithms 
        ...
        for j=1:10 % 10 runs for each dataset 
            ...
            [training_selected, testing_selected, feature_selected ] = chi2(30,training_data,training_label,testing_data, features(:,1:end-1));
            ...
            writetofile(subfolder,'WithFilterFeatureSelectionChi2',algoname, i,j,training_stat,testing_stat,train_time,test_time);
            ...
            featureswritetofile(subfolder,'WithFilterFeatureSelectionChi2',algoname, i,j,feature_selected);
        end
        
        avgvaltrain= mean(allvaluestraining);
        avgvaltest= mean(allvaluestesting);
        
        writeavgtofile(subfolder,'WithFilterFeatureSelectionChi2',algoname, i,avgvaltrain,avgvaltest);
